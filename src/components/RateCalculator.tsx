      ...
      <CollapsibleContent className="mt-3 space-y-3 rounded-lg border bg-card p-4">
        <div className="flex flex-col gap-3 sm:flex-row">
          <div className="flex-1">
            <label className="mb-1 block text-sm text-muted-foreground">{t("ratePerUnit", lang)}</label>
            <Input
              type="number"
              value={rate}
          ...
          <div className="w-full sm:w-[180px]">
            <label className="mb-1 block text-sm text-muted-foreground">Per</label>
        ...
        {totalValue > 0 && (
          <div className="rounded-lg bg-accent/10 p-4 text-center">
            <div className="text-sm text-muted-foreground">{t("totalValue", lang)}</div>
            <div className="mt-1 text-2xl font-bold text-accent">{formatted}</div>

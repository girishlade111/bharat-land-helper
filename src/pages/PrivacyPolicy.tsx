    ...
    <div className="min-h-screen bg-background">
      <div className="container max-w-3xl px-4 py-8 sm:py-10">
        ...
        <div className="mb-8">
          ...
          <p className="mt-1 text-sm text-muted-foreground">Last updated: March 8, 2026</p>
        </div>
        ...
        <div className="space-y-6 text-sm leading-relaxed text-foreground/90">
          ...
          <section className="rounded-xl border border-border/50 bg-card p-5">
            <h2 className="mb-3 text-base font-bold text-foreground">2. Information We Do NOT Collect</h2>
          ...
          <section className="rounded-xl border border-border/50 bg-card p-5">
            <h2 className="mb-3 text-base font-bold text-foreground">3. Data Stored Locally (localStorage)</h2>
            <p>
          ...
          <section className="rounded-xl border border-border/50 bg-card p-5">
            <h2 className="mb-3 text-base font-bold text-foreground">4. Third-Party Services</h2>
          ...
          <section className="rounded-xl border border-border/50 bg-card p-5">
            <h2 className="mb-3 text-base font-bold text-foreground">5. URL Parameters</h2>
            <p>
              When you use the "Share Link" feature, a URL is generated with query parameters (e.g., <code className="rounded-md bg-secondary/60 px-1.5 py-0.5 text-xs font-mono">?v=1000&u=sqft&s=Maharashtra</code>).
              These parameters contain only the conversion values you chose to share — no personal information is included.
            </p>
          </section>

          <section className="rounded-xl border border-border/50 bg-card p-5">
            <h2 className="mb-3 text-base font-bold text-foreground">6. Children's Privacy</h2>
            <p>
          ...
          <section className="rounded-xl border border-border/50 bg-card p-5">
            <h2 className="mb-3 text-base font-bold text-foreground">7. Security</h2>
            <p>
          ...
          <section className="rounded-xl border border-border/50 bg-card p-5">
            <h2 className="mb-3 text-base font-bold text-foreground">8. Changes to This Privacy Policy</h2>
            <p>

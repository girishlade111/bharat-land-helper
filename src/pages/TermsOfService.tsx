  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container max-w-3xl px-4 py-10">
        ...
        <p className="mb-8 text-sm text-muted-foreground">Last updated: March 11, 2026</p>
        ...
        <div className="space-y-8 text-sm leading-relaxed text-foreground/90">
          ...
          <section>
            <h2 className="mb-3 text-xl font-semibold text-foreground">3. Eligibility</h2>
          ...
          <section>
            <h2 className="mb-3 text-xl font-semibold text-foreground">4. User Responsibilities</h2>
          ...
          <section>
            <h2 className="mb-3 text-xl font-semibold text-foreground">5. Accuracy Disclaimer</h2>
            <div className="rounded-lg border border-amber-500/50 bg-amber-500/10 p-4">
              <p className="font-semibold text-amber-600">⚠️ Important Notice</p>
              <p className="mt-2">
          ...
          <section>
            <h2 className="mb-3 text-xl font-semibold text-foreground">6. Intellectual Property Rights</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 text-xl font-semibold text-foreground">7. Prohibited Uses</h2>
          ...
          <section>
            <h2 className="mb-3 text-xl font-semibold text-foreground">8. Third-Party Links</h2>
            <p>
          ...
          <section>
            ...
            <p className="mt-2">
              No advice or information, whether oral or written, obtained from Lade Stack or through the Service, will create
          ...
          <section>
            ...
            <div className="rounded-lg border bg-card p-4">
              ...
              <p className="mt-3">
                The foregoing limitations shall apply even if we have been advised of the possibility of such damages and
          ...
          <section>
            <h2 className="mb-3 text-xl font-semibold text-foreground">12. Modifications to the Service</h2>
            <p>
            ...
            <p className="mt-2">
              We may also add, remove, or modify features, functionality, content, or policies at any time. Your continued
              use of the Service after such modifications constitutes your acceptance of the changes.
            </p>
          </section>

          <section>
            <h2 className="mb-3 text-xl font-semibold text-foreground">13. Termination</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 text-xl font-semibold text-foreground">14. Governing Law and Jurisdiction</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 text-xl font-semibold text-foreground">15. Changes to These Terms</h2>
            <p>
          ...
          <section>
            <h2 className="mb-3 text-xl font-semibold text-foreground">16. Contact Information</h2>
            <p>
